...
_G.packer_plugins = {
  ...
  ["formatter.nvim"] = {
    loaded = true,
    path = "/home/alex/.local/share/nvim/site/pack/packer/start/formatter.nvim",
  ...
  ["obsidian.nvim"] = {
    loaded = true,
    path = "/home/alex/.local/share/nvim/site/pack/packer/start/obsidian.nvim",
  ...
  scvim = {
    loaded = true,
    path = "/home/alex/.local/share/nvim/site/pack/packer/start/scvim",
    url = "https://github.com/supercollider/scvim"
  },
  ["sessions.nvim"] = {
    loaded = true,
    path = "/home/alex/.local/share/nvim/site/pack/packer/start/sessions.nvim",
  ...
  ["vim-be-better"] = {
    loaded = true,
    path = "/home/alex/.local/share/nvim/site/pack/packer/start/vim-be-better",
    url = "https://github.com/szymonwilczek/vim-be-better"
  },
  ["vim-caser"] = {
    loaded = true,
    path = "/home/alex/.local/share/nvim/site/pack/packer/start/vim-caser",
  ...
  ["vim-javascript"] = {
    loaded = true,
    path = "/home/alex/.local/share/nvim/site/pack/packer/start/vim-javascript",
  ...
  ["vim-rest-console"] = {
    ...
    needs_bufread = true,
    only_cond = false,
    path = "/home/alex/.local/share/nvim/site/pack/packer/opt/vim-rest-console",
  ...
  ["vim-system-copy"] = {
    loaded = true,
    path = "/home/alex/.local/share/nvim/site/pack/packer/start/vim-system-copy",
    url = "https://github.com/christoomey/vim-system-copy"
  },
  ["vim-tidal"] = {
    loaded = true,
    path = "/home/alex/.local/share/nvim/site/pack/packer/start/vim-tidal",
...
time([[Sourcing ftdetect script at: /home/alex/.local/share/nvim/site/pack/packer/opt/vim-rest-console/ftdetect/rest.vim]], true)
vim.cmd [[source /home/alex/.local/share/nvim/site/pack/packer/opt/vim-rest-console/ftdetect/rest.vim]]
time([[Sourcing ftdetect script at: /home/alex/.local/share/nvim/site/pack/packer/opt/vim-rest-console/ftdetect/rest.vim]], false)
vim.cmd("augroup END")
